...
#can do audio signal preprocess here
...
#input size == record length? 48000*0.8
def conv_1d_time_stacked_model(input_size=48000*0.8, num_classes=11):
  ...
  x = input_layer
  print(x.shape)
  x = Reshape([800, 48])(x)    #original is [800,20] for sample rate 16000
  x = PreprocessRaw(x)
  ...
  x = Reshape([-1])(x)
  # multi layer input Model([input_layer1,input_layer2,...])
